<%@ Page Language="C#" MasterPageFile="~/ClientMasterPage.master" AutoEventWireup="true"
    CodeFile="CreateClient.aspx.cs" Inherits="CreateClient" Title="Untitled Page" %>
                    ...
                    <table width="98%" cellpadding="1" cellspacing="3">
                        ...
                        <tr>
                            ...
                            <td align="left" width="500">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Insert Date of Birth."
                        ...
                        <tr>
                            ...
                            <td align="left" width="500">
                                <asp:TextBox ID="txtAddress" runat="server" Width="320px" Height="100px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </fieldset>
                <fieldset>
                    ...
                    <table width="98%" cellpadding="1" cellspacing="3">
                        <tr>
                            ...
                            <td align="left" width="500" style="margin-left: 40px">
                                <asp:TextBox ID="txtUserName" runat="server" Width="200px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please Insert User Name."
                        ...
                        <tr>
                            ...
                            <td align="left" width="500">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please Insert Password Name."
                        ...
                        <tr>
                            ...
                            <td align="left" width="500">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Please Insert Confirm Password Name."
                    ...
                    <table width="98%" cellpadding="1" cellspacing="3">
                        ...
                        <tr>
                            <td style="width: 130px;" align="right">
                                Parent ID</td>
                            <td align="left" width="500">
                                <asp:TextBox ID="txtParentID" runat="server" Width="320px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 130px;" align="right">
                                Parent Hand</td>
                            <td align="left" width="500">
                                <asp:DropDownList ID="ddlParentHand" runat="server" Width="200px">
                        ...
                        <tr>
                            ...
                            <td align="left" width="500">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Please Insert key."
                                    ControlToValidate="txtKey"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 130px;" align="right">
